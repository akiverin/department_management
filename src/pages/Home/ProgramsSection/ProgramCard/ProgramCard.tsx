...
function ProgramCard({ program }: ProgramCardProps) {
    return (
        <div className={"program-card" + (program.level === "Магистратура" ? " program-card--magistracy" : "")}>
            ...
            <div className="program-card__body">
                <div className="program-card__content">
                    <div className="program-card__info">
                        ...
                        <p className="program-card__code">Код направления: {program.code}</p>
                        ...
                        <div className="program-card__places">
                            {program.budget_places &&
                                <div className="program-card__place">
                                    <p className="program-card__num-place">{program.budget_places}</p>
                                    <p className="program-card__type-place">бюджетных мест</p>
                                </div>
                            }
                            {program.paid_places &&
                                <div className="program-card__place">
                                    <p className="program-card__num-place">{program.paid_places}</p>
                                    <p className="program-card__type-place">платных мест</p>
                                </div>
                            }
                        </div>
                    </div>
                    <ul className="program-card__disciplines">
                        {program.disciplines.map(discipline => (
                            <li className="program-card__discipline">
                                <img src={tick} alt="Деокративная галочка для списка" className="program-card__tick" />
                ...
                <div className="program-card__action">
                    <TheButton to="/programs" full mini dark>Подробнее</TheButton>
                </div>
            </div>
        </div>
    )
