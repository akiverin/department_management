			...
			<div className="programs__wrapper">
				<div className="programs__info">
					...
					<p className="programs__desc">
						Получи всестороннее развитие лидерских и управленческих компетенций
						в управлении и менеджменте!
					</p>
				</div>
				<ul className="programs__cards">
					{programs.map(program => (
						<li className="programs__card" key={program.id}>
				...
				<div className="programs__help-programs help-programs">
					<div className="help-programs__info">
						<h4 className="help-programs__title">
							Нужна помощь с выбором программы?
						</h4>
						<p className="help-programs__desc">
							Если у вас остались вопросы или вам необходима помощь с выбором
							программы обучения, то свяжитесь с нами!
						</p>
					</div>
					<div className="help-programs__actions">
						<TheButton to="/" border light>
							Написать
						</TheButton>
						<TheButton to="/" gray>
							Позвонить
