		...
		<section className="skills">
			<div className="skills__wrapper">
				<div className="skills__info">
					...
					<h2 className="skills__title">Навыки, которые Вы&nbsp;получите</h2>
					<p className="skills__desc">
						Сбалансированный подход к овладению ключевыми навыками, необходимыми
						для успешного управления людьми, ресурсами и проектами.
					</p>
					<img
						src={arrowKnot}
						alt="Декоративная стрелка с узлом"
						height={120}
						width={120}
						className="skills__arrow-knot"
					/>
					<div className="skills__terms">
						...
						<div className="skills__arrow-term">
							<img
								...
								width={280}
								height={58}
								alt="Декоративная длинная стрелка"
								className="skills__arrow-long"
							/>
						...
						<div className="skills__star-term">
							...
							<img
								src={starBig}
								alt="Декоративная большая звездочка"
								className="skills__star-big"
							/>
						</div>
